...
import { Activity, ArrowUpRight, BrainCircuit, CheckCircle2, Database, History, LockKeyhole, LogIn, Radar, ShieldCheck, Sparkles, TriangleAlert } from "lucide-react";
          ...
          <div className="sticky top-28 space-y-6">
            <div className="rounded-2xl border border-white/10 bg-white/[0.035] p-5">
              ...
              <nav className="space-y-1 text-sm">
                <a className="flex items-center gap-3 rounded-xl bg-cyan-300/10 px-3 py-2.5 text-cyan-100" href="#analyze"><BrainCircuit className="h-4 w-4" />Analyze behavior</a>
...
function ResultBlock({ label, text, items, chips, accent }: { label: string; text?: string; items?: string[]; chips?: boolean; accent?: "amber" | "emerald" }) {
